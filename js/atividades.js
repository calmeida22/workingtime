...
const createRow = (client, index) => {
    ...
    newRow.innerHTML = `
        ...
        <td>${client.dataInicial}</td>
        <td>${client.dataFinal}</td>
        <td>
...
const fillFields = (client) => {
    ...
    document.getElementById('dataInicial').value = client.dataInicial
    document.getElementById('dataFinal').value = client.dataFinal
